...
Uint8List ? selectedImageByInBytes;
  ...
  String? url = await uploadImage(selectedImageByInBytes!, imagepath!);
                ...
                Stack(
                  children: [
                     CircleAvatar(
                      ...
                      ? Image.network('https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/default-profile-picture-male-icon.png',  fit: BoxFit.cover,)
